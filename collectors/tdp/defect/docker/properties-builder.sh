...
# find how many defect urls are configured
...
cat >> $PROP_FILE <<EOF
defect.servers[${i}]=${!server}
defect.usernames[${i}]=${!username}
defect.apiKeys[${i}]=${!apiKey}
defect.repos[${i}]=${!repos}
...
defect.endpoint=${ARTIFACTORY_ENDPOINT:-defect/}
EOF
